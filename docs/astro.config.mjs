...
gtag('config', 'G-MK59Q89KYW');`,
        ...
        {
          tag: "script",
          content: `document.addEventListener('DOMContentLoaded',()=>{document.querySelectorAll('nav:not([aria-label])').forEach(nav=>{nav.setAttribute('aria-label','Table of contents');});});`,
        },
      ],
      sidebar: [
        {
