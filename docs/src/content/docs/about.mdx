...
<div class="cv-download">
  <LinkButton
    href="/pdfs/nikolai-emil-damm-cv.pdf"
    variant="primary"
    icon="download"
    iconPlacement="start"
    download="Nikolai Emil Damm - CV.pdf"
  >
    Download CV (PDF)
  </LinkButton>
</div>
...
<dl class="about-meta">
  ...
  <div><dt>Interests</dt><dd>Fitness, running, gaming, music, technology</dd></div>
</dl>
...
<ul class="connect-bar">
  <li><a href="/pdfs/nikolai-emil-damm-cv.pdf" download="Nikolai Emil Damm - CV.pdf">Download CV</a></li>
