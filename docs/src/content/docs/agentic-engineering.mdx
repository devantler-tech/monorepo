...
block-beta
  ...
  block:Solution:6
    ...
    S4["<b>7. Review the proposed change</b><br/>Draft pull request · human and AI review"]
    ...
    S1["<b>4. Select the highest-value actionable task</b><br/>Issues · priorities · ownership claims"]
  end
...
1. **Select the highest-value actionable task.** Consider impact, urgency, age, dependencies, and whether another engineer already owns the work.
...
4. **Review the proposed change.** Use a draft pull request for human and AI review without implying that the work is ready.
