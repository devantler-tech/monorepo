...
deny	gh api repos/devantler-tech/PLACEHOLDER/pulls/PLACEHOLDER/reviews --paginate --jq '{head:"PLACEHOLDER",reviews:.}' | PLACEHOLDER/.claude/scripts/local-review-verdict.sh --input -
CORPUS
)
