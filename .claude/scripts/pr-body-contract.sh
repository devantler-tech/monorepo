...
validate_body() {
  ...
  routine_disclosure_count="$(grep -Ec '^> 🤖 Generated by the (Agentic Engineer|Agent Improver|Daily AI Engineer|Daily AI Assistant)$' \
    "${visible_body}" || true)"
