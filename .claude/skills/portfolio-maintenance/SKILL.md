...
- **Sweep your own disclosure drift — an undisclosed comment you authored reads as a MAINTAINER
  ...
  ```sh
  .claude/scripts/disclosure-drift-sweep.sh --since <ISO-8601-UTC> \
    --repo devantler-tech/platform --repo devantler-tech/monorepo \
    --repo devantler-tech/ksail --repo devantler-tech/actions
  ```
