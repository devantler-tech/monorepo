...
block is own-output: re-verify the finding at the current head and dismiss the superseded review
rather than treating it as feedback owed. A `devantler` review carrying **neither** marker is the
